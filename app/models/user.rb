class User < ApplicationRecord
  ...
  has_many :challenger, class_name: "ChallengeFriend", foreign_key: "challenger_id", dependent: :destroy
  has_many :challengee, class_name: "ChallengeFriend", foreign_key: "challengee_id", dependent: :destroy
