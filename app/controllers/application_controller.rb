class ApplicationController < ActionController::API
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: %i[full_name, profile_picture])
    devise_parameter_sanitizer.permit(:account_update, keys: %i[full_name, profile_picture])
  end
